...
public class BiodataFrame extends JFrame {
    private List<Biodata> biodataList;          //  untuk menyimpan biodata
    private final JTextField textFieldNama;     //  untuk menyimpan input nama
    private final JTextField textFieldHP;       //  untuk menyimpan input telepon
    private final JRadioButton jenisLaki;       //  untuk menyimpan input laki-laki
    private final JRadioButton jenisPerempuan;  //  untuk menyimpan input perempuan
    private final JTextArea txtOutput;          //  untuk menyimpan input alamat
    private final ModelTable tableModel;        //  untuk menyimpan tableModel
    private final JTable table;                 //  untuk menyimpan table
    private final JButton buttonSimpanUbah;     //  untuk menangani simpan ubah
    private final BiodataDao biodataDao;        //  untuk menyimpan biodataDao
    ...
    public BiodataFrame(BiodataDao biodataDao) {
        ...
        // Instansiasi JButton dengan nama buttonSimpanUbah yang diberikan nilai "Update"
        buttonSimpanUbah = new JButton("Update");
        // Atur ukuran panjang dan lebar serta posisi x dan y
        buttonSimpanUbah.setBounds(345, 380, 100, 40);
        ...
        // Atur ukuran panjang dan lebar serta posisi x dan y
        buttonFile.setBounds(455, 380, 130, 40);
    ...
    public void showAlertTelephoneEmpty() {
        // Tampilkan message dialog pada komponen dari parameter 1 dan pesan pada parameter 2 dengan title pada parameter 3 dan jenis pesan pada parameter 4
   JOptionPane.showMessageDialog(null, "Nomor Telepon belum di isi.", "Peringatan", JOptionPane.WARNING_MESSAGE);
    }
